...
use Tests\TestCase;
use App\Utils\PdfWithHtml;

class PdfWithHtmlTest extends TestCase
{
    /**
     * A basic test to generate a new PDF using HTML.
     *
     * @return void
     */
    ...
    {
        $dirname = '/home/rodrigo/app/personal/laravel-tests/storage/app/public/test/pdf/';
        $filename = 'test-02.pdf';
        $title = 'Olá mundo!';
        $description = [
        ...
        $pdf = new PdfWithHtml($dirname, $filename, $title, $description);
        $pdf->generate();
